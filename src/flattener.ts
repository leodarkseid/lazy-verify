 ...
 */
function resolveImportPath(importPath: string, currentFileAbsPath: string): string {
...
export function buildStandardJson(
    entryFileAbsolute: string,   // /abs/path/to/MyToken.sol
    ...
    function walk(fileAbs: string, fileVirtual: string) {
